# Lovepreet Singh
# Gesture Media Control using openCv,puautogui,mediapipe and pycaw library
# Gestures:
# Volume Control: Distance between thumb and index finger
# Play/Pause: all fingers and thumb folded
# Forward: all fingers and thumb folded except little finger
# Backward: all fingers and thumb folded except index finger
